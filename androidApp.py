...
#--------------------------------------------------------------------------
'''dictionary that contains the correspondence between items descriptions
and methods that actually implement the specific function and panels to be
shown instead of the first main_panel

SidePanel_AppMenu = {'MenuItem_text1':['AppMenu_METHOD_1',None],
                     'MenuItem_text2':['AppMenu_METHOD_2',None],
                     'MenuItem_text3':['AppMenu_METHOD_3',None],
                     }
